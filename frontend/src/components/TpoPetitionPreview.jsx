...
import petitionImage from '../images/tpoPetitionPreview.jpg';
      ...
      <div className="bg-white w-full md:w-md p-6 rounded-lg shadow-lg text-center">
        ...
        {showThankYou ? (
          ...
          <div ref={petitionRef} className="relative flex flex-col items-center w-full">
            ...
            {/* Overlay User Data */}
            <div className="absolute top-11 md:top-12 text-[#2BAE72] text-left left-7 md:left-7.5 text-[7px] lg:text-[11px] md:text-[10px] font-bold">
